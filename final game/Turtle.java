 ...
 */
	...
	/*
	Added by Steven Towns
	*/
	public long dot(double dotSize)
	{
		long timeStamp=storeCurrentState(true,false,dotSize,penColor,null,null,0,null);
		return timeStamp;
	}
   ...
   /**
	...
	public boolean onClick(String methodName, Turtle t, boolean append, boolean click, boolean repeat)
	{
		return addMouseBinding(methodName, t, append, click, repeat);
	}
	//String methodName,String keyText,boolean append,boolean repeat
